...
initial $sdf_annotate("addr_syn.sdf", UUT);
initial begin
    ...
    run_case("ADD max + max: 0xFF + 0xFF", 8'hFF, 8'hFF, 1'b1);
    run_case("ADD zero + zero", 8'h00, 8'h00, 1'b1);
    ...
    run_case("SUB underflow edge: 0x00 - 0xFF", 8'h00, 8'hFF, 1'b0);
    run_case("SUB self: A - A", 8'hA5, 8'hA5, 1'b0);
    ...
    run_case("ADD nibble carry chain: 0x0F + 0x01", 8'h0F, 8'h01, 1'b1);
